#데이터베이스 #NoSQL #CAP #BASE #분산시스템 #필수
## 정의
분산 DB의 CAP/BASE 특성
...
│  │                                                       │   │
│  │  ┌──────────────┐  ┌──────────────┐  ┌────────────┐ │   │
│  │  │  Basically   │  │    Soft      │  │ Eventually │ │   │
│  │  │  Available   │  │    State     │  │ Consistent │ │   │
│  │  ├──────────────┤  ├──────────────┤  ├────────────┤ │   │
│  │  │ 일부 노드    │  │ 데이터가     │  │ 시간이     │ │   │
│  │  │ 장애에도     │  │ 일시적으로   │  │ 지나면     │ │   │
│  │  │ 서비스 가능  │  │ 불일치 허용  │  │ 일관성 도달│ │   │
│  │  └──────────────┘  └──────────────┘  └────────────┘ │   │
│  │                                                       │   │
│  └─────────────────────────────────────────────────────┘   │
│                                                             │
